...
/*
this server was based on gogoplay4.com
*/
...
app.get('/api/iframe/:name_episode', (req, res) => {
    const url = `https://gogoplay4.com/videos/${req.params.name_episode}`
...
app.get('/api/anime/:name', (req, res) => {
    const url = `https://gogoplay4.com/videos/${req.params.name}`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            let anime = {}
...
app.get('/api/recently-added-sub', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/?page=${req.query.page}` : `https://gogoplay4.com`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/recently-added-raw', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/recently-added-raw?page=${req.query.page}` : `https://gogoplay4.com/recently-added-raw`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/recently-added-dub', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/recently-added-dub?page=${req.query.page}` : `https://gogoplay4.com/recently-added-dub`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/movies', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/movies?page=${req.query.page}` : `https://gogoplay4.com/movies`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/new-season', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/new-season?page=${req.query.page}` : `https://gogoplay4.com/new-season`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/popular', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/popular?page=${req.query.page}` : `https://gogoplay4.com/popular`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
...
app.get('/api/ongoing-series', (req, res) => {
    const url = req.query.page ? `https://gogoplay4.com/ongoing-series?page=${req.query.page}` : `https://gogoplay4.com/ongoing-series`
    axios.get(url,{ headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36' }  })
        .then((res) => res.data)
        .then((data) => {
            getSearchDom = new DOMParser().parseFromString(data, 'text/html')
